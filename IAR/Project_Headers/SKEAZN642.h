...
#if !defined(MCU_MKE02Z2) && !defined(MCU_SKEAZN642)  /* Check if memory map has not been already included */
#define MCU_MKE02Z2
...
#else /* #if !defined(MCU_MKE02Z2) && !defined(MCU_SKEAZN642) */
...
#endif  /* #if !defined(MCU_MKE02Z2) && !defined(MCU_SKEAZN642) */
