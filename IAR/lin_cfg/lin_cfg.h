...
#define LIN_BYTE_OFFSET_LI0_Motor1ErrorCode    11U
...
#define LIN_BYTE_OFFSET_LI0_Motor1ErrorValue    12U
...
#define LIN_BYTE_OFFSET_LI0_Motor1LinError    9U
...
#define LIN_BYTE_OFFSET_LI0_Motor1Selection    3U
...
#define LIN_BYTE_OFFSET_LI0_Motor1Temp    4U
...
#define LIN_BYTE_OFFSET_LI0_MotorSpeed    1U
#define LIN_BIT_OFFSET_LI0_MotorSpeed    0U
...
#define LIN_BYTE_OFFSET_LI0_Motor1Position    5U
...
#define l_u16_rd_LI0_MotorSpeed() \
    ((l_u16)  (((lin_pFrameBuf[LIN_BYTE_OFFSET_LI0_MotorSpeed] + (lin_pFrameBuf[LIN_BYTE_OFFSET_LI0_MotorSpeed + 1U] << 8U)) >> 0U) & 0x3ffU))


#define l_u16_wr_LI0_MotorSpeed(A) \
    { \
    buffer_backup_data[1U] =  lin_pFrameBuf[LIN_BYTE_OFFSET_LI0_MotorSpeed]; \
    lin_frame_updating_flag_tbl[LI0_MotorsControl] |= (1U << 1); \
    lin_pFrameBuf[LIN_BYTE_OFFSET_LI0_MotorSpeed] = \
    (l_u8)((lin_pFrameBuf[LIN_BYTE_OFFSET_LI0_MotorSpeed] & 0x00U) | \
    (((A) << 0U) & 0xffU)); \
    buffer_backup_data[1U + 1U] =  lin_pFrameBuf[LIN_BYTE_OFFSET_LI0_MotorSpeed + 1U]; \
    lin_frame_updating_flag_tbl[LI0_MotorsControl] |= (1U << (1 + 1U)); \
    lin_pFrameBuf[LIN_BYTE_OFFSET_LI0_MotorSpeed + 1U] = \
    (l_u8)((lin_pFrameBuf[LIN_BYTE_OFFSET_LI0_MotorSpeed + 1U] & 0xfcU) | \
    (((A) >> 8U) & 0x03U)); \
    lin_frame_updating_flag_tbl[LI0_MotorsControl] &= (~(0x03 << 1)); \
